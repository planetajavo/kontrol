    ...
    <aside className="github-sidebar">
      <div className="github-sidebar-content">
        ...
        <div className="github-sidebar-section">
          ...
          <Link to="/transactions/all" className={`github-sidebar-item ${location.pathname === '/transactions/all' || location.pathname === '/transactions' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
        ...
        <div className="github-sidebar-section">
          ...
          <Link to="/portfolio/wallets" className={`github-sidebar-item ${location.pathname === '/portfolio/wallets' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
          ...
          <Link to="/portfolio/exit-planner" className={`github-sidebar-item ${location.pathname === '/portfolio/exit-planner' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 1a7 7 0 110 14A7 7 0 018 1z"/>
              <path d="M8 4a.5.5 0 01.5.5v3h3a.5.5 0 010 1h-3v3a.5.5 0 01-1 0v-3h-3a.5.5 0 010-1h3v-3A.5.5 0 018 4z"/>
            </svg>
        ...
        <div className="github-sidebar-section">
          ...
          <Link to="/tax/pnl" className={`github-sidebar-item ${location.pathname === '/tax/pnl' || location.pathname === '/tax' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M1 2.75A.75.75 0 011.75 2h12.5a.75.75 0 010 1.5H1.75A.75.75 0 011 2.75zm0 5A.75.75 0 011.75 7h12.5a.75.75 0 010 1.5H1.75A.75.75 0 011 7.75zM1.75 12a.75.75 0 000 1.5h12.5a.75.75 0 000-1.5H1.75z"/>
            </svg>
            P&L
        ...
        <div className="github-sidebar-section">
          ...
          <Link to="/compliance/personal-info" className={`github-sidebar-item ${location.pathname === '/compliance/personal-info' || location.pathname === '/compliance' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
        ...
        {/* Agents */}
        <div className="github-sidebar-section">
          <div className="github-sidebar-title">AGENTS</div>
          <Link to="/agents/transaction" className={`github-sidebar-item ${location.pathname === '/agents/transaction' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M1.5 1.5A.5.5 0 000 2v12a.5.5 0 00.5.5h13a.5.5 0 00.5-.5V2a.5.5 0 00-.5-.5h-13zM1 2a1 1 0 011-1h12a1 1 0 011 1v12a1 1 0 01-1 1H2a1 1 0 01-1-1V2zm7.5 3a.5.5 0 00-.5.5v6a.5.5 0 001 0V6.707l2.146 2.147a.5.5 0 00.708-.708L8.5 5.707V5.5a.5.5 0 00-.5-.5z"/>
            </svg>
            Transaction Agent
          ...
          <Link to="/agents/tax-optimizer" className={`github-sidebar-item ${location.pathname === '/agents/tax-optimizer' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 1a7 7 0 110 14A7 7 0 018 1z"/>
              <path d="M8 4a.5.5 0 01.5.5v3h3a.5.5 0 010 1h-3v3a.5.5 0 01-1 0v-3h-3a.5.5 0 010-1h3v-3A.5.5 0 018 4z"/>
            </svg>
          ...
          <Link to="/agents/security" className={`github-sidebar-item ${location.pathname === '/agents/security' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 1a7 7 0 110 14A7 7 0 018 1z"/>
              <path d="M8 4a.5.5 0 01.5.5v3h3a.5.5 0 010 1h-3v3a.5.5 0 01-1 0v-3h-3a.5.5 0 010-1h3v-3A.5.5 0 018 4z"/>
            </svg>
          ...
          <Link to="/agents/legal" className={`github-sidebar-item ${location.pathname === '/agents/legal' ? 'active' : ''}`}>
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path fillRule="evenodd" d="M4 0h5.293A1 1 0 0110 1.707L14.293 6A1 1 0 0115 7.414V14a2 2 0 01-2 2H3a2 2 0 01-2-2V2a2 2 0 012-2zm5.5 6.5V2.5L13.5 6.5H9.5z"/>
            </svg>
            Legal Agent
